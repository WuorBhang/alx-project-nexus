"""
Django settings for alx-project-nexus project.
"""
...
WSGI_APPLICATION = 'alx-project-nexus.wsgi.application'
...
# Celery settings (optional - only used if Redis is available)
